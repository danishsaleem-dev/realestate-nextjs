  ...
  return (
    <div className='bg-white text-center py-40'>
        <div className='w-[60%] mx-auto flex flex-col gap-8 justify-center items-center'>
            ...
            <p className='text-slate-500 font-light text-2xl'>Welcome to Real Estate, where we turn houses into homes and dreams into reality. At Home, we understand that a home is more than just a physical space, it's a place where memories are created, families grow, and life unfolds.</p>
