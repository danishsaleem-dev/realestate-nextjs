...
const MobileNav = ({ closeNav, showNav }: Props) => {
  ...
  return (
    <div>
        ...
        {/* Mobile Nav */}
        <div className={`text-white transform ${navOpen} transition-all duration-500 delay-300 fixed flex justify-center flex-col h-full w-[80%] sm:w-[60%] bg-[#c1205e] space-y-6 z-[500]`}>
            {navLinks.map((link) => (
