...
const Hero = () => {
  return (
    <div className='w-full pt-[4vw] md:pt-[12vh] h-screen bg-[#0f0715] overflow-hidden relative bg-[url("/images/hero.jpg")] bg-cover bg-center'>
        {/* Overlay */}
        ...
        <div className='flex flex-col items-center justify-center text-white w-[95%] sm:w-[80%] h-full mx-auto relative'>
            ...
            <h1 data-aos="fade-up" data-aos-delay="150" className='uppercase text-center text-3xl font-semibold sm:text-5xl'>
